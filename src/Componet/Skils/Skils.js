...
const Skils = () => {
    return (
        <div className='pt-16 pb-16 gradient'>
        ...
        <div className='lg:flex lg:justify-center  mt-24'>
          ...
          <div className='mr-2'> 
           ...
           <div>
            ...
            <p className='inline lg:text-2xl md:text-2xl text-sm text-white'>javascript</p>
           </div>
           <div>
            <img className=' lg:w-[140px] md:w-[140px] w-24 lg:mt-5 inline lg:ml-32 md:ml-40 ml-10' src={github} alt=''></img>
        ...
        <div className='lg:flex lg:justify-center lg:mt-24 md:mt-20 mt-10'>
          ...
          <div className='flex'>
          <div className='mr-8'> 
           <img className='lg:w-24 md:w-24 w-16 lg:ml-0 md:ml-32 ml-3 mr-2 inline' src={reduxImg} alt=''></img>
           ...
           <div >
            <img className=' lg:w-16 md:w-16 w-12 mr-2 inline lg:ml-32 md:ml-32 ml-3' src={mongodbImg} alt=''></img>
